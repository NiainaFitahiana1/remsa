...
export const LoginForm = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Logique de connexion ici (API call, etc.)
  ...
  return (
    <div className="w-full max-w-[400px] rounded border border-slate-200 bg-white p-8 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
      <div className="mb-8 text-center">
        <h2 className="mb-2 text-xl font-bold text-navy dark:text-slate-100">Welcome Back</h2>
        <p className="text-sm text-slate-500 dark:text-slate-400">
          Enter your credentials to manage your deliveries.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <Button type="submit" className="w-full py-3.5 text-base shadow-sm">
          Login
        </Button>
      </form>
