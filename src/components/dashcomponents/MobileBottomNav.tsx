...
export default function MobileBottomNav() {
  ...
  // Version simple et sûre : match EXACT uniquement
  const isActive = (href: string) => pathname === href;

  return (
    <footer className="lg:hidden fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-md border-t border-border px-6 py-3 flex justify-between items-center z-50">
      <Link
        href="/dashboard"
